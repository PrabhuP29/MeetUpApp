    ...
    public class MessageRepository : IMessageRepository
    {
            ...
            string recipientUsername)
        {
            var messages = await _context.Messages
                //with projectTo the below 2 lines are not required**
                ...
                //added below line, projected now instead of at the end
                .ProjectTo<MessageDto>(_mapper.ConfigurationProvider)
                .ToListAsync();
            ...
            //projection used at the time of query creation, no need to map now
